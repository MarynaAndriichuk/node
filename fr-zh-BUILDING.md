...
Pour que cela fonctionne, le fichier de configuration OpenSSL (par défaut openssl.cnf) doit être mis à jour. Ce qui suit montre un exemple: Ce qui suit montre un exemple:
```console
