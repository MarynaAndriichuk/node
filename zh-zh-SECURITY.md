...
Node.js项目为安全研究人员和负责任的公开披露参与了官方的错误奖励方案。  该程序通过黑客一号平台进行管理。 更多详情请访问 <https://hackerone.com/nodejs>  该程序通过黑客一号平台进行管理。 更多详情请访问 <https://hackerone.com/nodejs>
...
感谢你改善Node.js及其生态系统的安全。 你的努力和负责任的披露受到高度赞赏，并将得到肯定。 你的努力和负责任的披露受到高度赞赏，并将得到肯定。
...
* 在禁运日，Node.js安全邮寄名单将寄送一份通告副本。 这些变化被推到公共仓库，新的建筑被部署到nodejs.org。 在接到通知的邮寄名单后6小时内，将在Node.js博客上公布咨询意见的副本。 这些变化被推到公共仓库，新的建筑被部署到nodejs.org。 在接到通知的邮寄名单后6小时内，将在Node.js博客上公布咨询意见的副本。

* 通常，从颁发CVE之日起算，禁运日期将定为72小时。 然而，这可能因错误的严重性或应用修复的难度而异。 然而，这可能因错误的严重性或应用修复的难度而异。

* 这一进程可能需要一些时间，特别是在需要与其他项目的维护者进行协调时。 这一进程可能需要一些时间，特别是在需要与其他项目的维护者进行协调时。 将尽一切努力尽可能及时地处理这个问题。 然而，我们必须遵循上述发布过程，以确保以一致的方式处理披露。
